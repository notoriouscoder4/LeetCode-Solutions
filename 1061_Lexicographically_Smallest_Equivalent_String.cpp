...
public:
    ...
    void Union(int x, int y)
    {
        ...
        // make smaller one parent of other. if parent are diffrent.
    ...
    string smallestEquivalentString(string s1, string s2, string baseStr)
    {
        ...
        // traverse in the baseStr and find parent of each char.
...
int main()
{
    ...
    Solution obj;
    auto ans = obj.smallestEquivalentString(s1, s2, baseStr);
    cout << ans << "\n";
